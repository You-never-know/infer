...
let atomicity_violation_error : t =
  register ~id:"ATOMICITY_VIOLATION_ERROR" ~category:Concurrency ~enabled:true Error AtomicityViolations
...
let atomicity_violation_warning : t =
  register ~id:"ATOMICITY_VIOLATION_WARNING" ~category:Concurrency ~enabled:true Warning AtomicityViolations
